...
public:
    ...
    virtual void visit(const Composite_Mod_Node& node);

    virtual void visit(const Composite_Factorial_Node& node);

    virtual void visit(const Composite_Power_Node& node);
};
