...
public:
    ...
    // Make the requested get command.  This method is used in
    // the implementation of the various commands.
    virtual Expression_Tree_Command make_get_command(const std::string&) = 0;

    // Make the requested list command.  This method is used in
    // the implementation of the various commands.
    virtual Expression_Tree_Command make_list_command(const std::string&) = 0;

    // Make the requested listVar command.  This method is used in
    // the implementation of the various commands.
    virtual Expression_Tree_Command make_listVar_command(const std::string&) = 0;

    // Make the requested history command.  This method is used in
    // the implementation of the various commands.
...
public:
    ...
    virtual Expression_Tree_Command make_listVar_command(const std::string&);
