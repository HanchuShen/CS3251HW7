...
public:
    ...
    virtual void get(Expression_Tree_Context& context, const std::string& format) = 0;

    virtual void list(Expression_Tree_Context& context) = 0;

    virtual void listVar(Expression_Tree_Context& context) = 0;

    virtual void history(Expression_Tree_Context& context) = 0;
...
public:
    ...
    void get(Expression_Tree_Context& context, const std::string& format) override;

    void list(Expression_Tree_Context&) override;

    void listVar(Expression_Tree_Context&) override;

    void history(Expression_Tree_Context&) override;
