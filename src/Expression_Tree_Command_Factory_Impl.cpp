...
Expression_Tree_Command Concrete_Expression_Tree_Command_Factory_Impl::make_list_command(
        const std::string& param)
{
    return Expression_Tree_Command(new List_Command(tree_context, param));
}

Expression_Tree_Command Concrete_Expression_Tree_Command_Factory_Impl::make_listVar_command(
        const std::string& param)
{
    return Expression_Tree_Command(new Var_Command(tree_context, param));
}

Expression_Tree_Command Concrete_Expression_Tree_Command_Factory_Impl::make_history_command(
        const std::string& param)
{
    return Expression_Tree_Command(new Hist_Command(tree_context, param));
}
    ...
    , tree_context(tree_context)
{
    ...
    command_map["stat"] = &Expression_Tree_Command_Factory_Impl::make_list_command;
    command_map["list"] = &Expression_Tree_Command_Factory_Impl::make_listVar_command;
