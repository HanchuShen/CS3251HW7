...
Get_Command::Get_Command(Expression_Tree_Context& context, const std::string& new_format)
        : Expression_Tree_Command_Impl(context)
        , cmd(new_format)
{
}

List_Command::List_Command(Expression_Tree_Context& context, const std::string& new_format)
        : Expression_Tree_Command_Impl(context)
        , cmd(new_format)
{
}

Var_Command::Var_Command(Expression_Tree_Context& context, const std::string& new_format)
        : Expression_Tree_Command_Impl(context)
        , cmd(new_format)
{
}

Hist_Command::Hist_Command(Expression_Tree_Context& context, const std::string& new_format)
        : Expression_Tree_Command_Impl(context)
        , cmd(new_format)
{
}
...
bool Var_Command::execute()
{
    tree_context.listVar();
    return true;
}

bool Hist_Command::execute()
{
    tree_context.histroy();
    return true;
}
